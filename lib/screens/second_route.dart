...
class _SecondRouteState extends State<SecondRoute> {
  ...
  //   String url = 'https://3fc9-103-179-103-130.in.ngrok.io/getAllbatsman/6373252f937ea228011fb1e6';
  ...
  //   List< Allrounder>? _playerList = _playersData.allrounder;
  //   print("_playerList 1 ${_playersData. allrounder}");
  //
        ...
        child: Column(
          children: [
            SizedBox(
              ...
              //       //print("snapshot ${snapshot.data}");
              //       List<Allrounder>? _DataList = snapshot.data;
              //       if (!snapshot.hasData) {
              //         return Text('Loading');
              //       } else {
              //         return
